...
package com.esyoung.exchangeskill.materialmenu;
...
import static com.esyoung.exchangeskill.materialmenu.MaterialMenuDrawable.DEFAULT_PRESSED_DURATION;
import static com.esyoung.exchangeskill.materialmenu.MaterialMenuDrawable.DEFAULT_SCALE;
import static com.esyoung.exchangeskill.materialmenu.MaterialMenuDrawable.DEFAULT_TRANSFORM_DURATION;
...
public abstract class MaterialMenuBase implements MaterialMenu {
    ...
    /**
     * Overwrites behaviour of pressed state circle animation even when using {@link #animatePressedState(com.es.android.materialmenu.MaterialMenuDrawable.IconState)}
     *
