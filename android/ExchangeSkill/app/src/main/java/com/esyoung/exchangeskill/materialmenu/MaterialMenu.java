...
public interface MaterialMenu {
    ...
    /**
     * Manually set a transformation value for an {@link com.sunywave.materialmenu.MaterialMenuDrawable.AnimationState}
     *
     * @param animationState state to set value in
     * @param value          between {@link com.sunywave.materialmenu.MaterialMenuDrawable#TRANSFORMATION_START} and
     *                       {@link com.sunywave.materialmenu.MaterialMenuDrawable#TRANSFORMATION_END}.
     */
